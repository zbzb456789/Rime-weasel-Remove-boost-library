...
void ContextUpdater::Store(const Deserializer::KeyType& k,
...
void ContextUpdater::_StoreCand(const Deserializer::KeyType& k,
                                const std::wstring& value) {
...
void StatusUpdater::Store(const Deserializer::KeyType& k,
                          const std::wstring& value) {
